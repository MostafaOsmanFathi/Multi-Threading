...
public class ThreadJoin {
    public static void main(String[] args) throws InterruptedException {
        ...
        //make parent thread wait the child thread
        thread1.join();
        thread2.join();
...
*
    ...
    Independent execution of threads
        When you create and start other threads, they run concurrently with the main thread unless instructed otherwise. So under normal circumstances, all threads run independent of each other. More explicitly, no thread waits for other thread.
    What is join()
